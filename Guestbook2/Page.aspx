        ...
        <div class="row">
            <div class="col-4">
                <form id="contact" runat="server" class="align-content-center">
                    ...
                    <h4 style="text-align: center;">What's on your mind?</h4>
                    <fieldset>
            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-12">
                        <asp:GridView ID="commentsGrid" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="OnPaging" PageSize="10" Width="370px" style="margin: 150px 0;">
                            <Columns>
